...
import {
  App,
  OnekjsDocsContentProvider,
  OnekjsCompletionItemProvider,
  OnekjsHoverProvider
} from './app';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  console.log(
    'Congratulations, your extension "onekjs-vscode-snippets-vue" is now active!'
  );
  let app = new App();
  app.setConfig();
  let docs = new OnekjsDocsContentProvider();
  let completionItemProvider = new OnekjsCompletionItemProvider();
  let hoverProvider = new OnekjsHoverProvider()
...
//   hover
  ...
  let disposable = vscode.commands.registerCommand(
    'onekjs-vscode-snippets.search',
    () => {
      // if (context.workspaceState.get('onekjs-vscode-snippets.loading', false)) {
