<template>
  ...
  <div>
    ...
    <span />
    <o-button plain disabled type="success">success</o-button>
    <span />
  ...
  <div>
    <span>按钮大小</span>
    <o-button size="mini" type="primary">mini</o-button>
    <span />
    <o-button size="small" type="primary">small</o-button>
    <span />
    <o-button size="normal" type="primary">normal</o-button>
    <span />
